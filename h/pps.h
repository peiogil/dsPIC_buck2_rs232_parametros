...
#define IN_PIN_PPS_RP60				60					/* Assign RP60 as Input Pin */
#define IN_PIN_PPS_RP61				61					/* Assign RP61 as Input Pin */
#define IN_PIN_PPS_RP62				62					/* Assign RP62 as Input Pin */
...
#define IN_PIN_PPS_RP72				72					/* Assign RP72 as Input Pin */
#define IN_PIN_PPS_RP73				73					/* Assign RP73 as Input Pin */
#define IN_PIN_PPS_RP74				74					/* Assign RP74 as Input Pin */
#define IN_PIN_PPS_RP75				75					/* Assign RP75 as Input Pin */
#define IN_PIN_PPS_RP76				76					/* Assign RP76 as Input Pin */
#define IN_PIN_PPS_RP77				77					/* Assign RP77 as Input Pin */
#define IN_PIN_PPS_RP78				78					/* Assign RP78 as Input Pin */
...
#define IN_PIN_PPS_RP83				83					/* Assign RP83 as Input Pin */
#define IN_PIN_PPS_RP84				84					/* Assign RP84 as Input Pin */
#define IN_PIN_PPS_RP85				85					/* Assign RP85 as Input Pin */
#define IN_PIN_PPS_RP86				86					/* Assign RP86 as Input Pin */
#define IN_PIN_PPS_RP87				87					/* Assign RP87 as Input Pin */
#define IN_PIN_PPS_RP88				88					/* Assign RP88 as Input Pin */
#define IN_PIN_PPS_RP89				89					/* Assign RP89 as Input Pin */
...
#define IN_PIN_PPS_RP124			124					/* Assign RP124 as Input Pin */
...
#define OUT_FN_PPS_U3TX				0x001C				/* RPn tied to UART3 Transmit */
#define OUT_FN_PPS_U3RTS			0x001D				/* RPn tied to UART3 Ready To Send */
#define OUT_FN_PPS_U4TX				0x001E				/* RPn tied to UART4 Transmit */
#define OUT_FN_PPS_U4RTS			0x001F				/* RPn tied to UART4 Ready To Send */
#define OUT_FN_PPS_SDO3				0x0020				/* RPn tied to SPI3 Data Output */
#define OUT_FN_PPS_SCK3				0x0021				/* RPn tied to SPI3 Clock Output */
#define OUT_FN_PPS_SS3				0x0022				/* RPn tied to SPI3 Slave Select Output */
#define OUT_FN_PPS_SDO4				0x0023				/* RPn tied to SPI4 Data Output */
#define OUT_FN_PPS_SCK4				0x0024				/* RPn tied to SPI4 Clock Output */
#define OUT_FN_PPS_SS4				0x0025				/* RPn tied to SPI4 Slave Select Output */
#define OUT_FN_PPS_OC9				0x0026				/* RPn tied to Output Compare 9 */
#define OUT_FN_PPS_OC10				0x0027				/* RPn tied to Output Compare 10 */
#define OUT_FN_PPS_OC11				0x0028				/* RPn tied to Output Compare 11 */
#define OUT_FN_PPS_OC12				0x0029				/* RPn tied to Output Compare 12 */
#define OUT_FN_PPS_OC13				0x002A				/* RPn tied to Output Compare 13 */
#define OUT_FN_PPS_OC14				0x002B				/* RPn tied to Output Compare 14 */
#define OUT_FN_PPS_OC15				0x002C				/* RPn tied to Output Compare 15 */
...
#define OUT_FN_PPS_C4OUT			0x0032				/* RPn tied to Output C4OUT */
